...
//这版代码需要把Reflectance Sesors的1~6连到Arduino的8~3，才能正常工作

Servo motor1, motor2;
const int motor1Pin = 11; //left
...
#define M1_default_speed 180  //normal speed of the Motor1， 不够快！！
...
void loop(){ 
  ...
  // write a function to change the position, espeacially for crooss and T corner
 //测试中能把传感器都打出来，传感器的固定
